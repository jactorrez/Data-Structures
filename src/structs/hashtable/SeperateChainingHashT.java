...
import structs.lists.LinkedListNode;
...
class WordList extends LinkedList<Word>{
	...
	public Word find(String word){
		...
		LinkedListNode<Word> current = head;
	...
	public void removeWord(String word){
		...
		LinkedListNode<Word> cur = head;
		LinkedListNode<Word> prev = null; 
